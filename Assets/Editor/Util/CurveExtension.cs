...
{
    /// <summary>
    /// see http://wiki.unity3d.com/index.php/EditorAnimationCurveExtension#C.23_-_KeyframeUtil.cs
    /// </summary>
    public static class CurveExtension
    {
        ...
        public static void ForceUpdateAllLinearTangents(this AnimationCurve curve)
        {
            for (int i = 0; i < curve.keys.Length; i++)
            {
                ForceUpdateTangentsFromMode(curve, i);
            }
        }

        // UnityEditor.CurveUtility.cs (c) Unity Technologies
        public static void ForceUpdateTangentsFromMode(AnimationCurve curve, int index)
        {
